...
bool Core::Stack::checkLeftRotation(Piece *piece) {
...
bool Core::Stack::checkLeftKickRotation(Piece *piece, int x_offset, int y_offset) {
...
bool Core::Stack::checkRightRotation(Piece *piece) {
    int pos_x = piece->pos_x;
    int pos_y = piece->pos_y;
    int rotation = modulo(piece->orientation - 1, 4);
    int x;
...
bool Core::Stack::checkRightKickRotation(Piece *piece, int x_offset, int y_offset) {
    int pos_x = piece->pos_x + x_offset;
    int pos_y = piece->pos_y + y_offset;
    int rotation = modulo(piece->orientation - 1, 4);
    int x;
