...
void Player::init(Stack *stack) {
    m_stack = stack;
}

void Player::init(Stack *stack, Mode *mode) {
    m_stack = stack;
    m_current_mode = mode;
...
void Player::changeLevel(int value, bool lineClear) {
...
void Player::updateScore(int nbLines, bool bravo) {
    /*combo += (2 * nbLines) - 2;
