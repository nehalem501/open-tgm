...
FrameImpl::FrameImpl(const Frame& frame) :
    ...
    const gpu_float_t texture_size = 16.0f; // TODO
    const ColorRGBA color = to_gpu_color(FrameColors::NORMAL);
    ...
    m_vertex_array.vertices[2].u = tile_size / texture_size;
    m_vertex_array.vertices[2].v = 1.0f;

    m_vertex_array.vertices[3].u = tile_size / texture_size;
    m_vertex_array.vertices[3].v = 0.25f;

    // Top
    m_vertex_array.vertices[4].u = tile_size / texture_size;
    ...
    m_vertex_array.vertices[7].u = tile_size / texture_size;
    ...
    m_vertex_array.vertices[9].u = tile_size / texture_size;
    m_vertex_array.vertices[9].v = 0.75f;

    m_vertex_array.vertices[10].u = tile_size / texture_size;
    ...
    // Left
    m_vertex_array.vertices[12].u = tile_size / texture_size;
    m_vertex_array.vertices[12].v = 0.0f;

    m_vertex_array.vertices[13].u = tile_size / texture_size;
...
void FrameImpl::resize() {
    ...
    const gpu_float_t width = 10;
    const gpu_float_t height = 22;
